...
class Usuario with ChangeNotifier{
  ...
  Future<void> deleteUsuario(int id_usuario) async{
    final response = await http.delete(
      Uri.parse('http://10.0.2.2:8000/usuario/del_usuario/$id_usuario'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
    );
    ...
    if(response.statusCode == 200){
      ...
      throw Exception('Fallo al intentar eliminar el usuario.');
    }
  }
}